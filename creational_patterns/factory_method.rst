...
- **使用工厂方法模式的另一个优点是在系统中加入新产品时，无须修改抽象工厂和抽象产品提供的接口，无须修改客户端，也无须修改其他的具体工厂和具体产品，而只要添加一个具体工厂和具体产品就可以了。这样，系统的可扩展性也就变得非常好，完全符合“开闭原则”。** 注：在维护代码时这种模式也非常方便，详见开闭原则的`好处`_。

.. _好处: https://baike.baidu.com/item/%E5%BC%80%E9%97%AD%E5%8E%9F%E5%88%99#5
...
利用面向对象的多态的特性，解决了前边提到的`简单工厂模式`违反了开闭原则的缺点。
